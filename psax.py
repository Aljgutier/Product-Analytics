...
def clusterheatmap(centers,columns,cmap='OrRd',**kwargs):
    corder = kwargs.get('corder', range(0,len(centers)))     
    fig = plt.figure(figsize=(14,8))
    fig.ax = sns.heatmap(centers.T[:,corder],cmap="OrRd",xticklabels=corder, yticklabels=columns,annot=True)
    plt.show()    
